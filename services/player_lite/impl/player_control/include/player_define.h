...
typedef enum {
    EVENT_ON_STATE_CHANGE,
    EVENT_FIRST_VIDEO_REND,
    EVENT_VIDEO_PTS_ERRGAP,
    EVENT_AUDIO_PTS_ERRGAP,
    EVENT_VIDEO_RUNNING_ERR,
    EVENT_AUDIO_RUNNING_ERR,
    EVENT_VIDEO_PLAY_EOS,
    EVENT_VIDEO_PLAY_SOS,
    EVENT_AUDIO_PLAY_EOS,
    EVENT_ON_JPEG_FRAME_RENDED,
    EVENT_FRAME_CONTINUE_LOST,
    EVENT_FIRST_AUDIO_REND,
    EVENT_BUTT
} EventCbType;
